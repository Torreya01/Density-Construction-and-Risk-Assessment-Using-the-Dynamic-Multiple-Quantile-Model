...
write.csv(apple_diff, "Data/Derived/apple_return.csv")
...
# Save the new return data
write.csv(apple_diff_new, "Data/Derived/apple_return_new.csv")
...
# Save the return data
write.csv(FTSE_diff, "Data/Derived/FTSE_return.csv")
...
# Save the return data
write.csv(FTSE_diff_new, "Data/Derived/FTSE_return_new.csv")
